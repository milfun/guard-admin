<template>
  <div class="p16">
    <el-card>
      <div class="flex item-center">
        <div class="flex-1 flex item-center">
          ...
          <span class="ml20 text-300" v-if="detail.mcChannels">
            渠道（{{ detail.mcChannels.cmName }}）
          </span>
        </div>
        <div class="flex item-center" v-permission="'rechargeMerchant'">
          <el-button type="primary" size="small" @click="onCoin">
            充值
          </el-button>
          <el-button type="primary" size="small" @click="onInvoice">
            预开票
          </el-button>
          <el-button type="primary" size="small" @click="onChannel">
            分配渠道
          </el-button>
        </div>
      </div>
    ...
    <!-- 业务信息 -->
    <el-card class="mt20" v-if="detail.mcBusiness">
    ...
    <!-- 税务信息 -->
    <el-card class="mt20" v-if="detail.mcTax">
...
import CoinDrawer from "./components/CoinDrawer.vue";
import PreInvoiceDrawer from "./components/PreInvoiceDrawer.vue";
import ChannelDrawer from "./components/ChannelDrawer.vue";

import { merchantDetail } from "@/api/merchant.js";
export default {
  data() {
    return {
      mcId: 0,
  ...
  methods: {
    ...
    onEditBusiness() {
      this.$drawer.open({
        ...
        width: "60%",
        value: { ...this.detail.mcBusiness, mode: "system" },
        callback: (res) => {
          this.getDetail();
        },
      });
    ...
    onEditTax() {
      this.$drawer.open({
        ...
        component: EditTax,
        width: "50%",
        value: { ...this.detail.mcTax, mode: "system" },
        callback: (res) => {
          this.getDetail();
        },
      });
