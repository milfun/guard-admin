  ...
  <el-card class="mt20">
    <el-form ref="form" :model="form" :rules="rules" label-width="200px">
      ...
      <el-form-item label="预计发放费用日期" prop="mbPreDate">
        <el-input v-model="form.mbPreDate" type="number" style="width: 420px" />

        <span class="text-200 ml20 f12">* 请填写数字,例：1 15 </span>
      </el-form-item>
      <el-form-item label="预计单人单月所得金额" prop="mbPreIncome">
        <el-input v-model="form.mbPreIncome" type="number" style="width: 420px">
      ...
      <el-form-item label="是否存在劳动/劳务关系" prop="mbIsConnect">
        <el-radio-group v-model="form.mbIsConnect" size="medium">
          <el-radio border :label="1">是</el-radio>
          <el-radio border :label="2">否</el-radio>
        </el-radio-group>
      </el-form-item>
      <el-form-item label="是否提供实名认证" prop="mbIsAuth">
        <el-radio-group v-model="form.mbIsAuth" size="medium">
          <el-radio border :label="1">是</el-radio>
          <el-radio border :label="2">否</el-radio>
        </el-radio-group>
      </el-form-item>
...
import { merchantAddBusiness, merchantBase } from "@/api/merchant";
